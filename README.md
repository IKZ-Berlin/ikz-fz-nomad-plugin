...
NOMAD plugin for Fz data used at IKZ Berlin
...
```
pip install dist/nomad-ikz-fz-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-ikz-fz" is free and open source software
